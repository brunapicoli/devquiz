  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: SafeArea(
        bottom: true, //prevents the buttons from being near the navigation button of the cell phone
        child: Padding(
          ...
          child: ValueListenableBuilder<int>(valueListenable: controller.currentPageNotifier, builder: (context, value, _) => Row(
            ...
            children: [
              ...
              Expanded(child: NextButtonWidget.green(label: "Confirmar", onTap: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ResultPage(title: widget.title, length: widget.questions.length, result: controller.amountAnswersRight)));
              })),
            ],
          )) 
        ),
